...
#define ASTRA_DEVICE_MANAGER_VERSION "2.0.0-prerelease"
...
public:
    ...
    void Boot(std::string bootImagesPath, std::string bootCommand = "", AstraDeviceBootStage bootStage = ASTRA_DEVICE_BOOT_STAGE_AUTO);
    bool Shutdown();
